# ChatPRD ingest — Professional Writing and Rhetoric — Professional Writers Produce User-Centered Documents

> **Frozen** — ingest saved under `chatprd_returns/peeples_2003_prof_writing_rhetoric_ch06_*_ingest.md`. Legacy schema; synthesis uses `synth_refine_per_source.md`.
...
| Chapter | `ch06` — Professional Writers Produce User-Centered Documents |
| Lane | `tic_enrichment` |
...
| rationale | User-centered design of workplace documents. |
...
1. `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/07_peeples_2003_prof_writing_rhetoric_ch06_ATTACH.txt`
...
Save to: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/peeples_2003_prof_writing_rhetoric_ch06_YYYYMMDD_ingest.md`

**Completed ingest on disk — prompt frozen for audit.** Re-run not required.

Next (synthesis only): attach saved ingest + `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/07_peeples_2003_prof_writing_rhetoric_ch06_ATTACH.txt` → paste `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/prompts/synth_refine_per_source.md` → `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/peeples_2003_prof_writing_rhetoric_ch06_refined_YYYYMMDD.md`
