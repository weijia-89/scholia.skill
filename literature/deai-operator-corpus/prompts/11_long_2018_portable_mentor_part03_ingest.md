# ChatPRD ingest — The Writer's Portable Mentor — Part III — Art of the Sentence and Paragraph

Platform: **Opus 4.6** · Slug: `long_2018_portable_mentor` · Chapter: `part03` · Lane: `both`  
Project: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/`

## Attach

1. `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/11_long_2018_portable_mentor_part03_ATTACH.txt`
...
| Field | Value |
| ----- | ----- |
| chapter_id | `part03` only |
| rationale | PRIMARY deai lane — sentence mechanics, diction, paragraph craft. Higher value than Part V revision process for prose-level signal removal. |
...
Save: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/long_2018_portable_mentor_part03_YYYYMMDD_ingest.md`
...
1. **Refine** — new ChatPRD window; attach saved ingest + primary attach (Gate A).
   - Primary Gate A: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/11_long_2018_portable_mentor_part03_ATTACH.txt`
   ...
   - Save: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/long_2018_portable_mentor_part03_refined_YYYYMMDD.md`
