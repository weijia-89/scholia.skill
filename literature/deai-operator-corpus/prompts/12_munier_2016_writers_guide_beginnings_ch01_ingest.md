# ChatPRD ingest — A Writer's Guide to Beginnings — In the Beginning Was the Word

> **Frozen** — ingest saved under `chatprd_returns/munier_2016_writers_guide_beginnings_ch01_*_ingest.md`. Legacy schema; synthesis uses `synth_refine_per_source.md`.
...
| Chapter | `ch01` — In the Beginning Was the Word |
| Lane | `tic_enrichment` |
...
| rationale | Opening hooks — cover letter / memo leads. |
...
Save to: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/munier_2016_writers_guide_beginnings_ch01_YYYYMMDD_ingest.md`

**Completed ingest on disk — prompt frozen for audit.** Re-run not required.

Next (synthesis only): attach saved ingest + `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/12_munier_2016_writers_guide_beginnings_ch01_ATTACH.txt` → paste `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/prompts/synth_refine_per_source.md` → `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/munier_2016_writers_guide_beginnings_ch01_refined_YYYYMMDD.md`
