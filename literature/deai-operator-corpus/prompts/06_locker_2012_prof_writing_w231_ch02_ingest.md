# ChatPRD ingest — Professional Writing (W231) — Adapting Your Message to Your Audience

> **Frozen** — ingest saved under `chatprd_returns/locker_2012_prof_writing_w231_ch02_*_ingest.md`. Legacy schema; synthesis uses `synth_refine_per_source.md`.
...
| Chapter | `ch02` — Adapting Your Message to Your Audience |
| Lane | `tic_enrichment` |
...
| rationale | Audience analysis — tic voice priming. |
...
Save to: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/locker_2012_prof_writing_w231_ch02_YYYYMMDD_ingest.md`

**Completed ingest on disk — prompt frozen for audit.** Re-run not required.

Next (synthesis only): attach saved ingest + `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/06_locker_2012_prof_writing_w231_ch02_ATTACH.txt` → paste `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/prompts/synth_refine_per_source.md` → `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/locker_2012_prof_writing_w231_ch02_refined_YYYYMMDD.md`
