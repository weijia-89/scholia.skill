# ChatPRD ingest — Professional Writing Skills — Lesson 3

> **Frozen** — ingest saved under `chatprd_returns/terk_prof_writing_skills_lesson03_*_ingest.md`. Legacy schema; synthesis uses `synth_refine_per_source.md`.
...
| Chapter | `lesson03` — Lesson 3 |
| Lane | `both` |
| Project | `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/` |

## Scope

Read **attached slice only** (FR-3). `chapters_attested = `lesson03` only.

| rationale | Concise writing — deai verbosity + tic clarity. |
...
1. `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/08_terk_prof_writing_skills_lesson03_ATTACH.txt`
...
Save to: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/terk_prof_writing_skills_lesson03_YYYYMMDD_ingest.md`

**Completed ingest on disk — prompt frozen for audit.** Re-run not required.

Next (synthesis only): attach saved ingest + `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/08_terk_prof_writing_skills_lesson03_ATTACH.txt` → paste `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/prompts/synth_refine_per_source.md` → `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/terk_prof_writing_skills_lesson03_refined_YYYYMMDD.md`
