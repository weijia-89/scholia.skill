# ChatPRD ingest — AI / writing detection research (s00146-024-01905-3)

> **Frozen** — ingest saved under `chatprd_returns/s00146_2024_ai_writing_*_ingest.md`. Legacy schema; synthesis uses `synth_refine_per_source.md`.
...
| Field | Value |
| ----- | ----- |
| title | AI / writing detection research (s00146-024-01905-3) |
| authors | unknown |
| year | 2024 |
| lane | `deai_removal` |
...
1. `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/03_s00146_2024_ai_writing_ATTACH.txt`
...
Save to: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/s00146_2024_ai_writing_YYYYMMDD_ingest.md`

**Completed ingest on disk — prompt frozen for audit.** Re-run not required.

Next (synthesis only): attach saved ingest + `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/03_s00146_2024_ai_writing_ATTACH.txt` → paste `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/prompts/synth_refine_per_source.md` → `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/s00146_2024_ai_writing_refined_YYYYMMDD.md`
