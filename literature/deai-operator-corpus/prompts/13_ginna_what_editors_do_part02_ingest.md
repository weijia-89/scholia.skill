# ChatPRD ingest — What Editors Do — Part II — The Editing Process

> **Frozen** — ingest saved under `chatprd_returns/ginna_what_editors_do_part02_*_ingest.md`. Legacy schema; synthesis uses `synth_refine_per_source.md`.
...
| Chapter | `part02` — Part II — The Editing Process |
| Lane | `both` |
...
| rationale | Line and developmental editing essays (Part II). |
...
Save to: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/ginna_what_editors_do_part02_YYYYMMDD_ingest.md`

**Completed ingest on disk — prompt frozen for audit.** Re-run not required.

Next (synthesis only): attach saved ingest + `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/13_ginna_what_editors_do_part02_ATTACH.txt` → paste `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/prompts/synth_refine_per_source.md` → `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/ginna_what_editors_do_part02_refined_YYYYMMDD.md`
