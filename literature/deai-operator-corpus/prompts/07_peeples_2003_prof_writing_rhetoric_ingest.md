# ChatPRD ingest — Professional Writing and Rhetoric: Readings from the Field

Platform: **Opus 4.6** · Slug: `peeples_2003_prof_writing_rhetoric` · Lane: `both` · Type: textbook  
...
**Chapter fan-out preferred** — use `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/prompts/07_peeples_2003_prof_writing_rhetoric_*_ingest.md` per `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chapter_curriculum.yaml`. Full attach below is fallback only.
...
Save: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/peeples_2003_prof_writing_rhetoric_YYYYMMDD_ingest.md`

```markdown
# Ingest — peeples_2003_prof_writing_rhetoric
...
1. **Refine** — new ChatPRD window; attach saved ingest + primary attach (Gate A).
   - Primary Gate A: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/07_peeples_2003_prof_writing_rhetoric_ch02_ATTACH.txt`
   ...
   - Save: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/peeples_2003_prof_writing_rhetoric_refined_YYYYMMDD.md`
