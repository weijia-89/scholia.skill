# ChatPRD ingest — Writing Workplace Cultures

Platform: **Opus 4.6** · Slug: `henry_2000_writing_workplace` · Lane: `both` · Type: textbook  
...
**Chapter fan-out preferred** — use `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/prompts/09_henry_2000_writing_workplace_*_ingest.md` per `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chapter_curriculum.yaml`. Full attach below is fallback only.
...
Save: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/henry_2000_writing_workplace_YYYYMMDD_ingest.md`

```markdown
# Ingest — henry_2000_writing_workplace
...
1. **Refine** — new ChatPRD window; attach saved ingest + primary attach (Gate A).
   - Primary Gate A: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/09_henry_2000_writing_workplace_part02_ATTACH.txt`
   ...
   - Save: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/henry_2000_writing_workplace_refined_YYYYMMDD.md`
