# ChatPRD ingest — Elements of the Writing Craft — Opening with an Encounter (Nonfiction)

> **Frozen** — ingest saved under `chatprd_returns/olmstead_2011_elements_writing_craft_craft03_*_ingest.md`. Legacy schema; synthesis uses `synth_refine_per_source.md`.
...
| Chapter | `craft03` — Opening with an Encounter (Nonfiction) |
| Lane | `both` |
| Project | `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/` |

## Scope

Read **attached slice only** (FR-3). `chapters_attested = `craft03` only.

| rationale | Revision and word choice — deai symptom overlap. |
...
1. `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/10_olmstead_2011_elements_writing_craft_craft03_ATTACH.txt`
...
Save to: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/olmstead_2011_elements_writing_craft_craft03_YYYYMMDD_ingest.md`

**Completed ingest on disk — prompt frozen for audit.** Re-run not required.

Next (synthesis only): attach saved ingest + `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/10_olmstead_2011_elements_writing_craft_craft03_ATTACH.txt` → paste `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/prompts/synth_refine_per_source.md` → `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/olmstead_2011_elements_writing_craft_craft03_refined_YYYYMMDD.md`
