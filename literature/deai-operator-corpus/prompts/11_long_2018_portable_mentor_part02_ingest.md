# ChatPRD ingest — The Writer's Portable Mentor — Part II — Finding a Structure

> **Frozen** — ingest saved under `chatprd_returns/long_2018_portable_mentor_part02_*_ingest.md`. Legacy schema; synthesis uses `synth_refine_per_source.md`.
...
| Slug | `long_2018_portable_mentor` |
| Chapter | `part02` — Part II — Finding a Structure |
| Lane | `tic_enrichment` |
...
| rationale | Structural analysis for documents; exceeds 119k attach — full text on disk. |

**Slice note:** Part II slice ~196k chars; attach truncates at 119k. Prefer full chapter path for Cursor reads. Not the sentence-craft core (see part03).
...
1. `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/11_long_2018_portable_mentor_part02_ATTACH.txt`
...
Save to: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/long_2018_portable_mentor_part02_YYYYMMDD_ingest.md`

**Completed ingest on disk — prompt frozen for audit.** Re-run not required.

Next (synthesis only): attach saved ingest + `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/11_long_2018_portable_mentor_part02_ATTACH.txt` → paste `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/prompts/synth_refine_per_source.md` → `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/long_2018_portable_mentor_part02_refined_YYYYMMDD.md`
