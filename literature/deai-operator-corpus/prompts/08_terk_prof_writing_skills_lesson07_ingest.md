# ChatPRD ingest — Professional Writing Skills — Email — Write Effective E-Mail

Platform: **Opus 4.6** · Slug: `terk_prof_writing_skills` · Chapter: `lesson07` · Lane: `tic_enrichment`  
Project: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/`

## Attach

1. `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/08_terk_prof_writing_skills_lesson07_ATTACH.txt`
...
| Field | Value |
| ----- | ----- |
| chapter_id | `lesson07` only |
| rationale | Email genre — high operator use. Body starts ~276983 (not 196512 cross-ref). |

ESL: operator L1 Chinese — no native-norm polish; tag `[esl_preserve]`. Lanes: `tic_enrichment` / tic_enrichment.
...
Save: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/terk_prof_writing_skills_lesson07_YYYYMMDD_ingest.md`
...
chapters_attested: `lesson07` only
...
1. **Refine** — new ChatPRD window; attach saved ingest + primary attach (Gate A).
   - Primary Gate A: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/08_terk_prof_writing_skills_lesson07_ATTACH.txt`
   ...
   - Save: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/terk_prof_writing_skills_lesson07_refined_YYYYMMDD.md`
