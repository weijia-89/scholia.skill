# ChatPRD ingest — Professional Writing Skills — Write the First Draft

> **Frozen** — ingest saved under `chatprd_returns/terk_prof_writing_skills_lesson02_*_ingest.md`. Legacy schema; synthesis uses `synth_refine_per_source.md`.
...
Read **attached slice only** (FR-3). `chapters_attested = `lesson02` only.

| rationale | Drafting process. |
...
1. `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/08_terk_prof_writing_skills_lesson02_ATTACH.txt`
...
Save to: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/terk_prof_writing_skills_lesson02_YYYYMMDD_ingest.md`

**Completed ingest on disk — prompt frozen for audit.** Re-run not required.

Next (synthesis only): attach saved ingest + `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/08_terk_prof_writing_skills_lesson02_ATTACH.txt` → paste `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/prompts/synth_refine_per_source.md` → `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/terk_prof_writing_skills_lesson02_refined_YYYYMMDD.md`
