# ChatPRD ingest — What Editors Do — Part III — Publication

> **Frozen** — ingest saved under `chatprd_returns/ginna_what_editors_do_part03_*_ingest.md`. Legacy schema; synthesis uses `synth_refine_per_source.md`.
...
| Chapter | `part03` — Part III — Publication |
| Lane | `tic_enrichment` |
| Project | `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/` |

## Scope

Read **attached slice only** (FR-3). `chapters_attested = `part03` only.

| rationale | Editor-as-manager and publication machinery. |

**Slice note:** Historically part03_ATTACH truncated at 119k and included the opening of Ch. 14 (Goldman) at the tail. Slice now ends at Part IV boundary — Ch. 14 is excluded. Ingest Goldman only via chapter_id ch14.
...
1. `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/13_ginna_what_editors_do_part03_ATTACH.txt`
...
Save to: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/ginna_what_editors_do_part03_YYYYMMDD_ingest.md`

**Completed ingest on disk — prompt frozen for audit.** Re-run not required.

Next (synthesis only): attach saved ingest + `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/13_ginna_what_editors_do_part03_ATTACH.txt` → paste `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/prompts/synth_refine_per_source.md` → `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/ginna_what_editors_do_part03_refined_YYYYMMDD.md`
