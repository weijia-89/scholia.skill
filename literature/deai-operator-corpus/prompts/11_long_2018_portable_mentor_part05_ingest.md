# ChatPRD ingest — The Writer's Portable Mentor — Part V — Getting the Work into the World

Platform: **Opus 4.6** · Slug: `long_2018_portable_mentor` · Chapter: `part05` · Lane: `both`  
Project: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/`

## Attach

1. `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/11_long_2018_portable_mentor_part05_ATTACH.txt`
...
| Field | Value |
| ----- | ----- |
| chapter_id | `part05` only |
| rationale | Revision/submission process scaffolding — keep but LOWER priority than Parts I–IV for deai_removal prose craft (process not diction core). |
...
Save: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/long_2018_portable_mentor_part05_YYYYMMDD_ingest.md`
...
1. **Refine** — new ChatPRD window; attach saved ingest + primary attach (Gate A).
   - Primary Gate A: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/attachments/11_long_2018_portable_mentor_part05_ATTACH.txt`
   ...
   - Save: `/Users/dubs/Projects/scholia.skill/literature/deai-operator-corpus/chatprd_returns/long_2018_portable_mentor_part05_refined_YYYYMMDD.md`
