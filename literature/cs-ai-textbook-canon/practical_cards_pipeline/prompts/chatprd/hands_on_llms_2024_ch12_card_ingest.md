# ChatPRD ingest — practical cards · hands_on_llms_2024 · 12
...
1. `/Users/dubs/Projects/scholia.skill/literature/cs-ai-textbook-canon/practical_cards_pipeline/attachments/hands_on_llms_2024_ch12_ATTACH.txt`
...
- `source_anchor` — prefer C-* from ingest; else `[read:body] hands_on_llms_2024_ch12_ingest.md §{section}`
...
`/Users/dubs/Projects/scholia.skill/literature/cs-ai-textbook-canon/practical_cards_pipeline/chatprd_returns/hands_on_llms_2024_ch12_cards.yaml`
...
source_ingests:
  - ingests/hands_on_llms_2024_ch12_ingest.md
cards:
  - exercise_name: ...
    steps: [...]
    cognitive_frame: ...
