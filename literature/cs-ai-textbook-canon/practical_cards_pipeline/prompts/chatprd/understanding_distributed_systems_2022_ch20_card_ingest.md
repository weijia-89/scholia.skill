# ChatPRD ingest — practical cards · understanding_distributed_systems_2022 · 20
...
1. `/Users/dubs/Projects/scholia.skill/literature/cs-ai-textbook-canon/practical_cards_pipeline/attachments/understanding_distributed_systems_2022_ch20_ATTACH.txt`
...
- `source_anchor` — prefer C-* from ingest; else `[read:body] understanding_distributed_systems_2022_ch20_ingest.md §{section}`
...
`/Users/dubs/Projects/scholia.skill/literature/cs-ai-textbook-canon/practical_cards_pipeline/chatprd_returns/understanding_distributed_systems_2022_ch20_cards.yaml`
...
source_ingests:
  - ingests/understanding_distributed_systems_2022_ch20_ingest.md
cards:
  - exercise_name: ...
    steps: [...]
    cognitive_frame: ...
