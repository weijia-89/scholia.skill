# ChatPRD ingest — practical cards · prompt_engineering_llms_2024 · 08
...
1. `/Users/dubs/Projects/scholia.skill/literature/cs-ai-textbook-canon/practical_cards_pipeline/attachments/prompt_engineering_llms_2024_ch08_ATTACH.txt`
...
- `source_anchor` — prefer C-* from ingest; else `[read:body] prompt_engineering_llms_2024_ch08_ingest.md §{section}`
...
`/Users/dubs/Projects/scholia.skill/literature/cs-ai-textbook-canon/practical_cards_pipeline/chatprd_returns/prompt_engineering_llms_2024_ch08_cards.yaml`
...
source_ingests:
  - ingests/prompt_engineering_llms_2024_ch08_ingest.md
cards:
  - exercise_name: ...
    steps: [...]
    cognitive_frame: ...
