# ChatPRD ingest — practical cards · hands_on_llms_2024 · 04
...
1. `/Users/dubs/Projects/scholia.skill/literature/cs-ai-textbook-canon/practical_cards_pipeline/attachments/hands_on_llms_2024_ch04_ATTACH.txt`
...
- `source_anchor` — prefer C-* from ingest; else `[read:body] hands_on_llms_2024_ch04_ingest.md §{section}`
...
`/Users/dubs/Projects/scholia.skill/literature/cs-ai-textbook-canon/practical_cards_pipeline/chatprd_returns/hands_on_llms_2024_ch04_cards.yaml`
...
source_ingests:
  - ingests/hands_on_llms_2024_ch04_ingest.md
cards:
  - exercise_name: ...
    steps: [...]
    cognitive_frame: ...
