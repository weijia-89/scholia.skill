# ChatPRD ingest — practical cards · ai_engineering_2025 · 08
...
1. `/Users/dubs/Projects/scholia.skill/literature/cs-ai-textbook-canon/practical_cards_pipeline/attachments/ai_engineering_2025_ch08_ATTACH.txt`
...
- `source_anchor` — prefer C-* from ingest; else `[read:body] ai_engineering_2025_ch08_ingest.md §{section}`
...
`/Users/dubs/Projects/scholia.skill/literature/cs-ai-textbook-canon/practical_cards_pipeline/chatprd_returns/ai_engineering_2025_ch08_cards.yaml`
...
source_ingests:
  - ingests/ai_engineering_2025_ch08_ingest.md
cards:
  - exercise_name: ...
    steps: [...]
    cognitive_frame: ...
